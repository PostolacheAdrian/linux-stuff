#!/bin/bash
PACKAGES="fastfetch os-prober efivar ntfs-3g wireless_tools networkmanager bluez alsa-firmware sof-firmware pipewire pipewire-alsa pipewire-jack pipewire-pulse wireplumber alsa-ucm-conf dhcpcd git mc acpid acpi"
